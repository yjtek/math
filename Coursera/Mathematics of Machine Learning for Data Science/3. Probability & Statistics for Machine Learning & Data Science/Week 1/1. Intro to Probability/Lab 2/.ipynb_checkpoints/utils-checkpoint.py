...
class monty_hall_game:
    ...
    def start(self) -> None:
        ...
        self.ax.clear()
        values = [10, 10, 10]
        door_numbers = ["Door 0", "Door 1", "Door 2"]
        ...
        self.prize_coordinates = [-0.1, 0.9, 1.9]
    ...
    def second_pick_mtd(self, x_coord):
        ...
        if self.final_choice == self.opened_door:
            self.ax.set_title(
                f"You selected the opened door so this game doesn't count"
            )
    ...
    def update_bar_chart(self):
        ...
        if self.first_pick:
            ...
            self.ax.set_title(
                f"You chose door {self.choice} and host opened door {self.opened_door}. Decide your final door."
            )
            ...
            self.ax.set_title(
                f"You decided{msg}to switch and chose door #{self.final_choice}\n You got a {self.prizes[self.final_choice]}"
            )
    ...
    def update_results_chart(self):
        ...
        self.results_ax.scatter(
            ["switch", "stay"],
            [
                self.memory_wins["switch"] / self.games_finished,
                self.memory_wins["stay"] / self.games_finished,
            ],
            s=350,
        )
